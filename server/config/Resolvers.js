...
const {GETSUGESTIONS,
    CREATESUGESTION,
    DELETESUGESTION} = require('../Models/Sugestion')
...
const resolvers = {
    ...
    Query:{
        ...
        sugestions: () => {return GETSUGESTIONS()},
    ...
    Mutation:{
        ...
        createSugestion: (parent,{title},context) =>{
            return CREATESUGESTION(title)
        },
        /* remove sugestão de titulo para jogos vindos do usuários */
        removeSugestion: (parent,{title},context)=>{
            return DELETESUGESTION(title)
        },
